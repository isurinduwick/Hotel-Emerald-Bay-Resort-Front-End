...
const INITIAL_PACKAGES: Package[] = [
  ...
  },
  {
    id: 2,
    title: "DINNER BUFFET",
    description: "Experience a lavish dinner buffet featuring local and international cuisine.",
    ctaText: "BOOK NOW",
  ...
  },
  {
    id: 3,
    title: "10% OFF",
    description: "Get 10% off on all room bookings when you book for 3 or more nights.",
    ctaText: "LEARN MORE",
  ...
  },
  {
    id: 4,
    title: "SPA RETREAT",
    description: "Indulge in a rejuvenating spa experience with full body treatments and aromatherapy.",
    ctaText: "EXPLORE",
  ...
  },
  {
    ...
    description: "A curated couples getaway with candlelit dining, spa, and sunset cruise.",
    ctaText: "BOOK NOW",
